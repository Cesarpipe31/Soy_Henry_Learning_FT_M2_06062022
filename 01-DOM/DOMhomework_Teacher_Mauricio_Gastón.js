...
// Tu codigo acá:
var toDoItems = [{description:qwe,complete:false}];
...
// Tu código acá:
// var nombre = "Mauricio"
let spanName = document.querySelector("#createdBy");
spanName.innerHTML = spanName.innerHTML + " Mauricio";
...
class ToDo {
  ...
  constructor(description) {
    ...
    this.complete = false; // si es true eliminar o tachar
    // next
    // size
    // boolean
  }
...
function buildToDo(todo, index) { // todo {description:"",complete:false}
  // Tu código acá:
  var toDoShell = document.createElement("div"); // <div></div>
  toDoShell.setAttribute("class", "toDoShell"); // <div class='toDoShell'></div>
  var toDoText = document.createElement("span"); // <span></span>
  toDoText.innerHTML = todo.description // <span>"description"</span> <-- in html
  toDoText.setAttribute('id', index)// <span id=numIndex>"description"</span>
  if(todo.complete){
    toDoText.setAttribute("class", "completeText")// <span id=numIndex class='completeText'>"description"</span>
  }
...
//  6) Abrir el HTML o en el caso de ya tenerlo abierto, recargar, la página
...
function displayToDos() {
  ...
  /*
  <div class='toDoShell'>
    <span id=numIndex>"h"</span>
  </div>
  */
 /*
  <div class='toDoShell'>
    <span id=numIndex>"c"</span>
  </div>
  */
